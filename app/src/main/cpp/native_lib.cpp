...
Java_com_shine56_easywrite_ui_longessay_LacUtil_initLac(JNIEnv *env, jobject thiz, jstring model_path) {
...
/*
Java_com_shine56_easywrite_ui_longessay_LacUtil_initLac(JNIEnv *env, jobject thiz, jbyteArray buffer, jint length) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_shine56_easywrite_ui_longessay_LacUtil_releaseLac(JNIEnv *env, jobject thiz) {
    uPtr_Lac.release();
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_shine56_easywrite_ui_longessay_LacUtil_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_shine56_easywrite_ui_longessay_LacUtil_stringCutFromJNI(JNIEnv *env, jobject thiz,
                                                       jstring source_text) {
