...
class SquareVm : BaseViewModel(){
    ...
    private fun getTodayWorks(): List<ShortEssayWork> {
        ...
        list.add(ShortEssayWork(photoId = R.drawable.cat, text = "我的童年，和这只猫儿一样，眷恋在这条小巷中。", headImgId = R.drawable.head_example, loveCount = 18, authorName = "Alice"))

        list.add(ShortEssayWork(photoId = R.drawable.work3, text = "我见青山多妩媚，料青山，见我应如是。\n\n——辛弃疾《贺新郎》", headImgId = R.drawable.head_example, loveCount = 218, authorName = "Alice"))


        list.add(ShortEssayWork(photoId = R.drawable.learn, text = "明天的你，会感谢今天努力的自己。", headImgId = R.drawable.head_example, loveCount = 10, authorName = "Alice"))
